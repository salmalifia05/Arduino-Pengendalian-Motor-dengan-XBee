...
void setup() {
  ...
  Serial.println("Simulasi Pengendali Motor DC dgn XBee:");
  Serial.println();
...
void loop() {
  ...
  if(data == '2') {DataCheck = 1; digitalWrite(Motor1, LOW); digitalWrite(Motor2, HIGH); Serial.println("Motor Pertama berputar berlawanan searah jarum jam");}
  ...
  if(data == '5') {DataCheck = 1; digitalWrite(Motor4, LOW); digitalWrite(Motor3, HIGH); Serial.println("Motor Kedua berputar berlawanan searah jarum jam");}
  if(data == '6') {DataCheck = 1; digitalWrite(Motor3, LOW); digitalWrite(Motor4, LOW); Serial.println("Motor Kedua BERHENTI");}
  if(DataCheck == 0) {Serial.println("Perintah Salah. Silahkan Ulangi !!! ");}
  Serial.println();
  DataCheck = 0;
  }
}
